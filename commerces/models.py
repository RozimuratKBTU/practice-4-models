...
class Order(models.Model):
    ...
    restaurant = models.ForeignKey('catalog.Restaurant', on_delete=models.CASCADE, related_name='orders')
    ...
    discount_total = models.DecimalField(max_digits=10, decimal_places=2, default=Decimal('0.00'), validators=[MinValueValidator(0)])
...
class OrderItem(models.Model):
    ...
    menuitem = models.ForeignKey('catalog.MenuItem', null=True, blank=True, on_delete=models.SET_NULL)
...
class OrderPromo(models.Model):
    ...
    applied_amount = models.DecimalField(max_digits=10, decimal_places=2, default=Decimal('0.00'), validators=[MinValueValidator(0)])
